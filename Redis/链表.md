...
![pic-3-1](/home/user/workspace/notebook/Redis/images/pic-3-1.jpg)
...
图 3-2 是由一个 `list` 结构和三个 `listNode` 结构组成的链表：![pic-3-2](/home/user/workspace/notebook/Redis/images/pic-3-2.jpg)
